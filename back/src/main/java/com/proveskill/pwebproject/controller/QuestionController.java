...
public class QuestionController {
    ...
    public ResponseEntity<List<Question>> getQuestionBySearch(@PathVariable("search") String search,
            Model model) {
        List<Question> questions = this.questionService.searchQuestions(search);
        return ResponseEntity.ok(questions);
    }

    @PutMapping(value = PathConstants.QUESTIONS, consumes = "application/json",
